...
export const en = {
  ...
  fetchDetectedSummary: '{total} models detected ({newCount} new)',
  fetchNoNewModels: '{total} models detected (no new models)',
  modelsAdopted: '{count} models added',
  ...
  paidModels: 'Other models',
  onlyFree: 'Only free',
  noFreeModels: 'No free models in this fetch.',
  testMini: 'Test',
  ...
  onboardingTitle: 'Choose a provider to get started',
  onboardingDescription: 'Pick any model provider. Official DeepSeek is optional.',
  onboardingLater: 'Configure later',
  onboardingBack: 'Back',
  onboardingSearch: 'Search providers',
  onboardingEmpty: 'No matching providers.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  fetchDetectedSummary: '检测到 {total} 个模型（{newCount} 个新模型）',
  fetchNoNewModels: '检测到 {total} 个模型（无新模型）',
  modelsAdopted: '已添加 {count} 个模型',
  fetchSearch: '搜索模型',
  ...
  onboardingTitle: '选择一个提供方开始使用',
  onboardingDescription: '可选择任意模型提供方。官方 DeepSeek 不是必选项。',
  onboardingLater: '稍后配置',
  onboardingBack: '返回',
  onboardingSearch: '搜索提供方',
  onboardingEmpty: '没有匹配的提供方。',
